...
PROJECTNAME = ncp-list-all-bondings
...
$(shell mkdir -m 0755 $(OBJ_DIR)>$(NULLDEVICE) 2>&1)
$(shell mkdir -m 0755 $(EXE_DIR)>$(NULLDEVICE) 2>&1)
$(shell mkdir -m 0755 $(LST_DIR)>$(NULLDEVICE) 2>&1)
...
C_SRC +=  \
dump.c \
${LOC_SDK}/protocol/bluetooth/ble_stack/src/host/gecko_bglib.c \
${LOC_SDK}/support.c \
main.c \
app.c \
